 ...
 */
    ...
    public abstract class Packet {
        ...
        protected final static byte PT_VKEY         = (byte)0xF0;
        ...
        public void send(InetAddress adr, int port) throws IOException
        {
           ...
           /*Object localObject2 = new StringBuilder();
            ...
            ((StringBuilder)localObject1).append(("h") localObject2);
            ((StringBuilder)localObject1).append(getUDPMessage(((StringBuilder) localObject1).length() + (MAX_PAYLOAD_SIZE - 1) / MAX_PAYLOAD_SIZE).toString()).append("\r\n");
            localObject2 = ((StringBuilder)localObject1).toString().getBytes("US-ASCII");
            DatagramPacket paramOutgoingDatagramMessage = new DatagramPacket((byte[])localObject2, localObject2.length);*/
        }
